LARGE = False # Set false for 8B, set true for 32B
...
DATA_DIR = "/workspace/frit-data" # Directory where data files are stored (set this as the directory where you cloned https://github.com/Anut-py/frit-data)
